...
vi.mock('@features/curation/services/enabled-modes-service', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@features/curation/services/enabled-modes-service')>();
  return {
    ...actual,
