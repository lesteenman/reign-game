...
- CloudFront serves from S3 origin via OAC — no bucket policy granting public read
- Outputs: CloudFront distribution domain name, S3 bucket name, S3 bucket ARN
