...
| R-08A | Backend auth middleware + admin route wiring    | 1     | [x]    |
| R-08B | Frontend sign-in flow + user menu + admin route | 1     | [x]    |
| R-08C | Glossary + CLAUDE.md + ROADMAP + KI-009 close   | 2     | [x]    |
