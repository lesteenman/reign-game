...
func (s *BacktrackSolver) GenerateSolution(gridSize int, markersPerUnit int) [][]bool {
...
func (s *BacktrackSolver) CountSolutions(regionMap [][]int, gridSize int, markersPerUnit int, maxSolutions int) int {
